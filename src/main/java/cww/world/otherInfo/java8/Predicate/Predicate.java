package cww.world.otherInfo.java8.Predicate;

import cww.world.otherInfo.java8.po.Father;
import cww.world.otherInfo.java8.po.FatherAndSon;
import cww.world.otherInfo.java8.po.Son;
